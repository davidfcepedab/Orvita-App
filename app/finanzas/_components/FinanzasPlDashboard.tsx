    ...
    <div className="space-y-6 sm:space-y-8">
      <section className="overflow-hidden rounded-2xl border border-orbita-border/85 bg-orbita-surface shadow-[var(--shadow-card)]">
        <div className="border-b border-orbita-border/50 bg-[color-mix(in_srgb,var(--color-accent-finance)_7%,var(--color-surface))] px-4 py-5 sm:px-6">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
            <div className="min-w-0">
              <p className="text-[10px] font-semibold uppercase tracking-[0.2em] text-orbita-secondary">Periodo</p>
              <h2 className="mt-1 text-xl font-bold capitalize tracking-tight text-orbita-primary sm:text-2xl">
                {monthLabel}
              </h2>
              <p className="mt-3 max-w-xl text-xs leading-relaxed text-orbita-secondary">
                Lectura tipo estado de resultados: de arriba abajo, de lo ya ocurrido al cierre operativo.
              </p>
            </div>
          ...
          <div className="mt-5 grid gap-3 sm:grid-cols-2">
            <div className="rounded-xl border border-orbita-border/70 bg-orbita-surface/90 p-4 shadow-sm">
              <p className="text-[10px] font-semibold uppercase tracking-wide text-orbita-muted">Continuidad (mes previo)</p>
              ...
              <p className="mt-2 text-[10px] leading-snug text-orbita-muted">
                Flujo neto del mes calendario anterior (no es saldo bancario).
              </p>
            </div>
            <div className="flex flex-col justify-center rounded-xl border border-dashed border-orbita-border/60 bg-orbita-surface-alt/40 p-4">
              <p className="text-[10px] font-medium leading-snug text-orbita-secondary">
                Referencia:{" "}
                <Link
                  href="/finanzas/cuentas"
                  className="font-semibold text-[color-mix(in_srgb,var(--color-accent-finance)_82%,var(--color-text-primary))] underline-offset-2 hover:underline"
                >
                  Cuentas
                </Link>{" "}
                para saldos ledger; esta vista es flujo del hogar.
              </p>
            </div>
          </div>
        </div>
        ...
        <details className="group border-t border-orbita-border/55 bg-orbita-surface-alt/25">
          <summary className="flex cursor-pointer list-none items-center justify-between gap-2 px-4 py-3 text-xs font-semibold text-orbita-primary sm:px-6 [&::-webkit-details-marker]:hidden">
          ...
          <div className="space-y-2 border-t border-orbita-border/40 px-4 pb-4 pt-2 text-xs leading-relaxed text-orbita-secondary sm:px-6">
      ...
      <Card className="overflow-hidden border-orbita-border/85 shadow-[var(--shadow-card)]">
        <div className="border-b border-orbita-border/65 bg-[color-mix(in_srgb,var(--color-surface-alt)_45%,var(--color-surface))] px-4 py-4 sm:px-5">
          <div className="flex flex-wrap items-end justify-between gap-2">
            <div>
              <p className="text-[10px] font-bold uppercase tracking-[0.16em] text-orbita-secondary">Estado de resultados</p>
              <p className="mt-0.5 text-xs text-orbita-muted">Columna única de importes (COP). Pasar el cursor sobre una partida con puntos: ayuda breve.</p>
            </div>
        ...
        <div className="border-b border-orbita-border/55 bg-orbita-surface-alt/20 px-4 py-4 sm:px-5">
          <p className="text-[10px] font-bold uppercase tracking-[0.14em] text-orbita-secondary">Indicadores clave</p>
          <div className="mt-3 grid grid-cols-1 gap-3 sm:grid-cols-3">
            <KpiCard
              dense
              label="Ingresos"
              value={<MoneyCell value={c.incomeTotal} variant="success" />}
              sub="Suma movimientos ingreso"
            />
            <KpiCard
              dense
              label="Gasto total"
              value={<MoneyCell value={c.expenseTotalAll} variant="danger" />}
              sub="Todos los egresos del mes"
            />
            <KpiCard
              dense
              label="Flujo neto"
          ...
          <div className="mt-4 grid grid-cols-1 gap-2 sm:grid-cols-3">
            ...
            <KpiCard
              ...
              value={
                <MoneyCell
                  value={c.unexplainedKpiStructural}
                  variant={Math.abs(c.unexplainedKpiStructural) < 1 ? "muted" : "danger"}
                />
              }
              sub="Tras puentes"
          ...
          <p className="mt-3 text-[10px] leading-snug text-orbita-muted">
